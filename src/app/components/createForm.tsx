...
export function CreateForm({ form, data, option, value, event }: FormProps): JSX.Element {
  const { controlId, label, as, ariaLabel, name, type, placeholder, autoComplete, required, disabled, readOnly, plaintext, min, max, patern, invalidMessage, optionKey, ...rest } =
    form;
